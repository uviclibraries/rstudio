...
#### [Task 4.4.3:]{.underline} Filter all the rows from purchaseData where `Sub_Category` is "Phones" and `Order_Priority` is "Critical".
...
#### [Task 4.7.1:]{.underline} Use the `summary()` function to create a single data frame with the mean and median length.
...
#### [Task 4.8.1:]{.underline} Group by `state_name` and summarize the length of mussels by `state`.
