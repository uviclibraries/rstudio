...
Moreover, remember that AI models can also hallucinate and produce incorrect code. You don't want to find yourself in a situation like the [reddit user](https://www.reddit.com/r/ClaudeAI/comments/1pgxckk/claude_cli_deleted_my_entire_home_directory_wiped/) below, who didn't check their code and ended up to get their entire home directory wiped out... 

![Claude AI gone wrong](images/claude-ai.png)
