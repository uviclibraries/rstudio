...
In our dataset, multiple column names begin with "Product". We want to see only the data in columns whose names begin with "Product."
...
[**Note for Chloe: ADD TO BASICS 0 The `summarise()` function takes unlimited parameters, where each parameter is a statistical function.]{.underline}
