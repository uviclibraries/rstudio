...
# Plot
ggplot(df) +
  geom_density(aes(x = normal2), colour = "darkgreen", linewidth = 1.5) +
  geom_density(aes(x = poskur), colour = "darkblue", linewidth = 1.5) +
  geom_density(aes(x = negkur), colour = "darkred", linewidth = 1.5) +
  geom_text(label = "Normal", x = 1, y = 0.28, hjust = 0, colour = "darkgreen", size = 6) +
  geom_text(label = "Positive kurtosis", x = 2.3, y = 0.4, hjust = 0.5, colour = "darkblue", size = 6) +
  geom_text(label = "Negative kurtosis", x = -3.9, y = 0.15, hjust = 0.5, colour = "darkred", size = 6) +
  theme_classic() +
  theme(
...
# Plot
ggplot(df) +
  geom_density(aes(x = normal), colour = "darkgreen", linewidth = 1.5) +
  geom_density(aes(x = poskew), colour = "darkblue", linewidth = 1.5) +
  geom_density(aes(x = negkew), colour = "darkred", linewidth = 1.5) +
  geom_text(label = "Symmetric", x = 0, y = 0.45, hjust = 0.5, , colour = "darkgreen", size = 6) +
  geom_text(label = "Positive\nskew", x = -3.5, y = 0.45, hjust = 0.5, , colour = "darkblue", size = 6) +
  geom_text(label = "Negative\nskew", x = 3.5, y = 0.45, hjust = 0.5, , colour = "darkred", size = 6) +
  theme_classic() +
  theme(
    axis.title = element_blank(),
    axis.text = element_blank(),
